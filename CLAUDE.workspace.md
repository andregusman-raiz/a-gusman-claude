...
- **SQL multi-DB**: PBI_DATASET (matriculas/financeiro), TOTVS RM (RH/ponto), Neon (HubSpot/Layers/Zeev). Detalhes + guards em `.claude/rules/sql-multi-db-governance.md`.
