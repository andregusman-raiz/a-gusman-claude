...
**Data:** 2026-03-08
**Status:** Aceito
**Contexto:** example-platform usa Jest, rAIz-AI-Prof usa Vitest. Ambos sao vitest-compatible na API.
...
- Migrar example-platform para Vitest seria refatoracao de risco sem beneficio claro
