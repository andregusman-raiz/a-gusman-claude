...
## Deploy Info
- **Ultimo deploy**: !`vercel ls --limit 1 2>/dev/null | tail -1 || echo "vercel CLI not configured"`

# ag-D-38 — Smoke Test Vercel
...
Diferenca de ag-Q-22: ag-Q-22 testa fluxos completos. ag-D-38 verifica apenas se o deploy esta vivo e funcional.
...
- ag-D-19: Chamado automaticamente apos deploy
- ag-D-20: Se smoke falha, ag-D-20 monitora e pode acionar rollback
- ag-D-27: Integrado como etapa final do deploy pipeline
- ag-B-09: Se smoke detecta problema, escalar para depuracao
