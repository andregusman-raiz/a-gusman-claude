...
Diferenca de ag-testar-qualidade-qat: ag-testar-qualidade-qat avalia qualidade ABSOLUTA. ag-benchmark-qualidade avalia qualidade RELATIVA (parity).
Diferenca de ag-testar-ux-qualidade: ag-testar-ux-qualidade avalia qualidade VISUAL/UI. ag-benchmark-qualidade avalia conteudo AI comparativamente.
Diferenca de ag-criar-cenario-benchmark: ag-criar-cenario-benchmark CRIA cenarios. ag-benchmark-qualidade EXECUTA e orquestra PDCA.
...
- Agent completo: `~/.claude/agents/ag-benchmark-qualidade.md`
