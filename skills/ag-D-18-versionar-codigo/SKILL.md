...
Spawn the `ag-D-18-versionar-codigo` agent to manage git operations: branches, semantic commits, PRs, releases, and changelog.
...
- `subagent_type`: `ag-D-18-versionar-codigo`
- `mode`: `auto`
