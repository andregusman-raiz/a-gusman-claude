...
1. Spawnar ag-registrar-issue para registrar GitHub Issue com contexto completo:
```
Agent({
...
- **Se nao resolvido**: GitHub Issue criada via ag-registrar-issue com todo o contexto
