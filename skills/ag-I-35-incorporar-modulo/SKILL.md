...
Spawn the `ag-I-35-incorporar-modulo` agent to execute module incorporation following the roadmap and task_plan. Implements ACL, migrations, sync, and UI adapters.

## Invocation

Use the **Agent tool** with:
- `subagent_type`: `ag-I-35-incorporar-modulo`
...
Roadmap path: [path do roadmap ag-I-34]
...
Pre-condicao: roadmap aprovado (ag-I-34) + task plan da fase atual.
