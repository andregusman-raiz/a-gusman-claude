...
> Fonte canonica no repo data-engine-app: `docs/runbooks/access-broker-approval-links.md`,
...
em `api_consumers`. Slug textual (ex.: `example-platform`) nao e aceito e produz vinculo
