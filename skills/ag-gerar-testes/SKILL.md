...
# ag-gerar-testes — Gerar Testes via MCP
...
Diferenca de ag-testar-e2e: ag-testar-e2e escreve testes baseado em specs/codigo. ag-gerar-testes gera testes baseado em observacao real do browser via MCP.
...
- ag-testar-manual: Explora primeiro (manual), ag-gerar-testes automatiza os fluxos validados
- ag-testar-e2e: Testes gerados se integram a suite existente do ag-testar-e2e
- ag-testar-codigo: Testes gerados complementam unit tests do ag-testar-codigo
