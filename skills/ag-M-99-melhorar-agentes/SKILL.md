...
```
/ag-M-99-melhorar-agentes diagnosticar [ag-XX] → Analisar reports de um agente específico
/ag-M-99-melhorar-agentes calibrar → Avaliar todos os agentes
/ag-M-99-melhorar-agentes panorama → Visão geral do sistema
/ag-M-99-melhorar-agentes benchmark [ag-XX] → Rodar evals quantitativos via ag-M-49-criar-skill
/ag-M-99-melhorar-agentes otimizar-description [ag-XX] → Otimizar triggering via ag-M-49-criar-skill
```

## Fontes de dados

1. `docs/ai-state/errors-log.md` → Padrões de falha recorrentes
2. `validation-report.md` → O que o ag-Q-12 encontra repetidamente
...
## Integracao com ag-M-49-criar-skill

Para avaliacao quantitativa de skills, ag-M-99 delega ao ag-M-49-criar-skill:
...
- **Grader agent**: `~/.claude/skills/ag-M-49-criar-skill/agents/grader.md` — avalia assertions
- **Comparator agent**: `~/.claude/skills/ag-M-49-criar-skill/agents/comparator.md` — blind A/B
- **Analyzer agent**: `~/.claude/skills/ag-M-49-criar-skill/agents/analyzer.md` — post-hoc analysis
- **Viewer**: `~/.claude/skills/ag-M-49-criar-skill/eval-viewer/generate_review.py` — HTML review
- **Workspace**: `~/.claude/skills-workspace/[skill-name]/` — resultados de evals

Workflow: ag-M-99 identifica skill que precisa melhoria → ag-M-49-criar-skill roda evals → ag-M-99 interpreta resultados → propoe melhoria
## Cadência sugerida

- Após cada projeto → `/ag-M-99-melhorar-agentes panorama`
- Quando um agente falha 2+ vezes → `/ag-M-99-melhorar-agentes diagnosticar [ag-XX]`
- A cada 5 projetos → `/ag-M-99-melhorar-agentes calibrar`
...
- [ ] Alinhamento com ag-M-00 (catalogo, atalhos, workflows)?
...
|------|-------|----------|---------------------|
| 2026-03-03 | ag-M-00 | Adicionado ag-W-31 ao catalogo | 22 → 24 |
| 2026-03-03 | ag-Q-13 | Corrigido ref ag-Q-14 → ag-Q-22 | 20 → 21 |
...
| 2026-03-03 | ag-P-05 | Modelo opus → sonnet (pesquisa nao precisa opus) | - |
...
| 2026-03-03 | ag-M-00 | Documentados 5 pattern skills no catalogo | 22 → 23 |
| 2026-03-03 | 9 skills | Adicionada secao Output (deliverables) | - |
| 2026-03-03 | 5 skills | Adicionada secao Anti-Patterns (ag-B-08,10,17,18,19) | - |
| 2026-03-03 | ag-Q-22 | Condensado de 589 → 333 linhas (43% reducao) | 19 → 22 |
| 2026-03-04 | 5 skills | Corrigidos paths D:/ → ~/ (ag-M-00,01,03,29,31) | - |
| 2026-03-04 | ag-P-06 | Expandido: modos, template SPEC, anti-patterns, interacoes, Ralph Loop | 16 → 23 |
| 2026-03-04 | ag-Q-14 | Expandido: checklist design, severidades, anti-patterns, interacoes | 16 → 23 |
| 2026-03-04 | ag-Q-16 | Expandido: Nielsen, WCAG 2.1 AA, mobile, anti-patterns, interacoes | 16 → 23 |
| 2026-03-04 | 13 skills | Adicionadas secoes Anti-Patterns e/ou Interacoes faltantes | - |
| 2026-03-04 | ag-D-27, ag-M-28 | Adicionada secao Quality Gate formal | - |
| 2026-03-05 | ag-B-09 | Decision tree, checklist, exemplos, ferramentas, description ampliada | 17 → 24 |
```
