...
/ag-M-99-melhorar-agentes benchmark [ag-XX] → Rodar evals quantitativos via ag_skill-creator
/ag-M-99-melhorar-agentes otimizar-description [ag-XX] → Otimizar triggering via ag_skill-creator
```
...
Para avaliacao quantitativa de skills, ag-M-99 delega ao ag_skill-creator:
...
Workflow: ag-M-99 identifica skill que precisa melhoria → ag_skill-creator roda evals → ag-M-99 interpreta resultados → propoe melhoria
## Cadência sugerida
