...
# ag-mapear-integracao — Mapear Integracao

Spawn the `ag-mapear-integracao` agent to map all integration dimensions between an external system and rAIz Platform. Identifies contact points, conflicts, and migration paths.

## Invocation

Use the **Agent tool** with:
- `subagent_type`: `ag-mapear-integracao`
- `mode`: `auto`
...
Due diligence path: [path do relatorio ag-avaliar-software, se disponivel]
...
Pre-condicao: due diligence concluida (ag-avaliar-software) com recomendacao GO.
