---
name: ag-W-30-organizar-arquivos
...
# ag-W-30 — Organizar Arquivos

Spawn the `ag-W-30-organizar-arquivos` agent to organize files and folders with intelligent taxonomy. Scans, classifies, proposes structure, waits for approval, then executes.

## Invocation

Use the **Agent tool** with:
- `subagent_type`: `ag-W-30-organizar-arquivos`
- `mode`: `auto`
