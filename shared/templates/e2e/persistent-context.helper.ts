...
export const GOOGLE_SSO_SUPPORTED: ProjectId[] = [
  'example-platform', // Supabase Auth com Google OAuth habilitado
  'example-prof',
  'example-automata',
  'edu-portal',
  'fin-platform',
...
export const GOOGLE_SSO_UNSUPPORTED: ProjectId[] = [
  'edu-frontend', // TOTVS Auth proprio
  'attendance-app', // TOTVS Auth proprio
...
export interface LaunchOptions {
  ...
  /** profile suffix para multi-role (ex: 'admin' → example-platform-admin) */
  role?: string;
  openPage?: boolean;
  /**
