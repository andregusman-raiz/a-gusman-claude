...
# ag-testar-qualidade-qat — QAT PDCA Orchestrator
...
Diferenca de ag-testar-e2e (E2E): ag-testar-e2e verifica se fluxos FUNCIONAM. Voce verifica se outputs tem QUALIDADE.
Diferenca de ag-smoke-vercel (smoke): ag-smoke-vercel verifica se deploy esta VIVO. Voce avalia se conteudo gerado e BOM.
Diferenca de ag-criar-cenario-qat (scenario): ag-criar-cenario-qat CRIA cenarios. Voce EXECUTA cenarios e orquestra o ciclo PDCA.
...
- **ag-testar-e2e**: Complementar — ag-testar-e2e testa fluxos, ag-testar-qualidade-qat testa qualidade dos outputs
- **ag-pipeline-deploy**: Pos-deploy — rodar QAT apos deploy para validar qualidade em producao
- **ag-smoke-vercel**: Sequencial — primeiro ag-smoke-vercel (smoke), depois ag-testar-qualidade-qat (qualidade) se smoke passa
- **ag-ciclo-testes**: Diferente — ag-ciclo-testes corrige testes, ag-testar-qualidade-qat avalia outputs (nao corrige)
- **ag-criar-cenario-qat**: Complementar — ag-criar-cenario-qat cria cenarios, ag-testar-qualidade-qat executa e orquestra PDCA
