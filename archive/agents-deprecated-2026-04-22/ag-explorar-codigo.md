...
- ag-analisar-contexto (analisar): consome o mapa para diagnosticar debito tecnico
- ag-especificar-solucao (especificar): usa findings para informar a spec
- ag-implementar-codigo (construir): usa project-profile.json para contexto
