...
- Agent esgotou tentativas de fix (ag-depurar-erro max 2, ag-corrigir-bugs gates falharam)
- Auditoria encontrou finding P0/P1 (ag-verificar-seguranca)
- Testes falhando persistentemente (ag-testar-codigo, ag-testar-e2e)
- Tech debt critico P0 identificado (ag-analisar-contexto)
- Incidente em producao detectado (ag-monitorar-producao)
- Item marcado SKIP apos ciclo completo (ag-ciclo-testes)
