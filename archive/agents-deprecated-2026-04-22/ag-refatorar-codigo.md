...
# ag-refatorar-codigo — Refatorar Código
...
Rode /ag-testar-codigo primeiro para criar a rede de segurança.
...
- **NUNCA "refatorar para aprender"** — entender o código primeiro, depois refatorar. Pesquisa é do ag-pesquisar-referencia.
- **NUNCA ignorar testes falhando após refatoração** — "quase funciona" = falha. Revert e investigue a causa raiz com ag-depurar-erro.
