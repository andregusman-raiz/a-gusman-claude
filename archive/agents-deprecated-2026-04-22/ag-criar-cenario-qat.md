...
Diferenca de ag-testar-qualidade-qat: ag-testar-qualidade-qat EXECUTA cenarios existentes. Voce CRIA cenarios novos.
Diferenca de ag-testar-codigo: ag-testar-codigo cria testes unitarios/integracao. Voce cria testes de QUALIDADE de output.
...
Next: /ag-testar-qualidade-qat [url] QAT-XX  (para executar)
```
...
- **ag-testar-codigo**: Diferente — ag-testar-codigo cria testes unitarios/integracao, ag-criar-cenario-qat cria testes de qualidade
