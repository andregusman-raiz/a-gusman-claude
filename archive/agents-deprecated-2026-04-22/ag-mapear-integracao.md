...
- Due diligence concluida (ag-avaliar-software) com recomendacao GO
...
2. Explorar codebase do rAIz (ag-explorar-codigo subagent se necessario)
...
- ag-avaliar-software (due-diligence): fornece o relatorio base
- ag-explorar-codigo (explorar): mapeia codebase quando necessario
- ag-planejar-incorporacao (planejar-incorporacao): consome o mapa para criar roadmap
