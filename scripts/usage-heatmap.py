...
Usage:
    ...
    python3 ~/Claude/.claude/scripts/usage-heatmap.py --project example-platform
...
def parse_project_name(dir_name: str) -> str:
    """Converte '-Users-andregusmandeoliveira-Claude-GitHub-example-platform' → 'example-platform'"""
