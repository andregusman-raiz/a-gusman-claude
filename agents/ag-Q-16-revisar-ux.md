...
> usar ag-Q-42 (UX-QAT). ag-Q-16 continua valido para reviews rapidos e pontuais.

## Modos de uso

```
/ag-Q-16 [tela ou fluxo]        -> Review completo de UX
/ag-Q-16 benchmark [produto]    -> Compara com referencia de mercado
/ag-Q-16 acessibilidade         -> Foca em a11y (WCAG 2.1 AA)
/ag-Q-16 mobile [tela]          -> Foca em experiencia mobile
```
