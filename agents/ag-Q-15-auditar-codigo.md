...
```
/ag-Q-15 [modulo]           -> Auditoria completa
/ag-Q-15 seguranca          -> Foco em vulnerabilidades
/ag-Q-15 secrets            -> Busca secrets expostos
/ag-Q-15 deps               -> Audita dependencias
```
...
### Fluxo
1. Parent ag-Q-15 avalia tamanho do projeto
...
4. Parent ag-Q-15 agrega em report unico com severidade consolidada
