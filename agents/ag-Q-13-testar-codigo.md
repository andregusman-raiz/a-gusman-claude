...
- NÃO faz E2E (browser, UI) — isso é do ag-Q-22
...
Quando acionado por ag-P-07 com flag `--from-spec`:
...
Quando acionado por ag-B-08 apos implementacao:
...
- ag-P-07 (planejar): recebe spec para modo --from-spec (Phase 0 / Red)
- ag-B-08 (construir): apos implementacao, verifica se testes passam (Green)
- ag-B-09 (depurar): se testes revelam bugs, escalar para depuracao
- ag-B-10 (refatorar): apos refactor, re-rodar testes para garantir estabilidade
