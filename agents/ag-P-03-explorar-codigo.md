...
- ag-P-04 (analisar): consome o mapa para diagnosticar debito tecnico
- ag-P-06 (especificar): usa findings para informar a spec
- ag-B-08 (construir): usa project-profile.json para contexto
