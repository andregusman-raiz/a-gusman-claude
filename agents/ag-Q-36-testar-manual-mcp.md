...
Diferenca de ag-Q-22: ag-Q-22 escreve e roda scripts Playwright. ag-Q-36 navega manualmente via CLI e reporta.
...
## Referencia completa
Ver `.claude/skills/ag-Q-36-testar-manual-mcp/SKILL.md` para templates de report e patterns de interacao CLI.
