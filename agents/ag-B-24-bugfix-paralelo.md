...
- Se < 6 bugs → usar ag-B-23 (bugfix-batch)
- Se bugs compartilham muitos arquivos → usar ag-B-23 (sequencial)
...
- ag-B-09 (depurar): usado internamente por cada agent paralelo
- ag-B-23 (batch): fallback se paralelismo nao se justifica
- ag-Q-12 (validar): chamado na fase 4 para validacao integrada
- ag-D-18 (versionar): para merge coordinator
