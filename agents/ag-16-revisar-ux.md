...
```
/ag16 [tela ou fluxo]        -> Review completo de UX
/ag16 benchmark [produto]    -> Compara com referencia de mercado
/ag16 acessibilidade         -> Foca em a11y (WCAG 2.1 AA)
/ag16 mobile [tela]          -> Foca em experiencia mobile
```
