...
- NÃO faz E2E (browser, UI) — isso é do ag-22
...
- ag-07 (planejar): recebe spec para modo --from-spec (Phase 0 / Red)
- ag-08 (construir): apos implementacao, verifica se testes passam (Green)
- ag-09 (depurar): se testes revelam bugs, escalar para depuracao
- ag-10 (refatorar): apos refactor, re-rodar testes para garantir estabilidade
