...
## Integracao com ag-W-29 (Gerar Documentos)

Chamado AUTOMATICAMENTE na Fase 3 do ag-W-29:
...
Fluxo ag-W-29 atualizado:
```
Gerar → Spell Check (ag-W-31) → Validar Estrutura → Entregar
```

## Integracao com ag-W-21 (Documentar Projeto)
...
```
/ag-W-31 apresentacao.pptx          # Corrigir PPTX
/ag-W-31 relatorio.docx             # Corrigir DOCX
/ag-W-31 README.md                  # Corrigir Markdown
/ag-W-31 documento.pdf --report-only # Reportar erros em PDF
/ag-W-31 *.pptx                     # Corrigir todos PPTX no diretorio
```
