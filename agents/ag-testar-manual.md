...
# ag-testar-manual — Testar Manual via Playwright CLI
...
Diferenca de ag-testar-e2e: ag-testar-e2e escreve e roda scripts Playwright. ag-testar-manual navega manualmente via CLI e reporta.
...
- NUNCA modificar codigo durante teste exploratorio — apenas observar e reportar
- NUNCA testar sem capturar evidencias (screenshots obrigatorios)
- NUNCA ignorar erros de console — documentar todos
- NUNCA deixar sessao browser aberta apos teste (`playwright-cli close-all`)
- NUNCA assumir que "funciona" sem verificar mobile viewport

## Quality Gate

Antes de declarar QA exploratorio completo:
- [ ] Report gerado em `tests/reports/manual-test-[data].md`?
- [ ] Screenshots de todos os bugs encontrados?
- [ ] Fluxos criticos testados em desktop E mobile?
- [ ] Erros de console documentados?
- [ ] Sessoes browser fechadas?

## Referencia completa
Ver `.claude/skills/ag-testar-manual/SKILL.md` para templates de report e patterns de interacao CLI.
