...
```
/ag-D-18-versionar-codigo branch [nome]    -> Cria feature branch a partir de main
/ag-D-18-versionar-codigo commit           -> Commit com mensagem semantica
/ag-D-18-versionar-codigo pr               -> Cria PR com template completo
/ag-D-18-versionar-codigo tag [versao]     -> Cria tag de release
/ag-D-18-versionar-codigo changelog        -> Atualiza changelog
/ag-D-18-versionar-codigo release [versao] -> Changelog + tag + GitHub Release
/ag-D-18-versionar-codigo cleanup          -> Remove branches mergeadas locais
```
...
- **NUNCA mergear branches com testes falhando** — testes falhando = risco de regressao. Faca ag-Q-13 passar primeiro.
- **NUNCA push direto em main** — sempre via feature branch + PR.

## Interacao com outros agentes

- ag-B-08 (construir): chama ag-D-18 ao final para commitar e criar PR
- ag-B-23 (bugfix): Gate 5 usa logica de commit do ag-D-18
- ag-D-27 (deploy-pipeline): deploy via PR merge, nao push direto
- ag-W-21 (documentar): changelog gerado pelo ag-D-18
