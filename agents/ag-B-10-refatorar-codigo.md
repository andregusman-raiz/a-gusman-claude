...
Rode /ag-Q-13-testar-codigo primeiro para criar a rede de segurança.
...
- **NUNCA "refatorar para aprender"** — entender o código primeiro, depois refatorar. Pesquisa é do ag-P-05.
- **NUNCA ignorar testes falhando após refatoração** — "quase funciona" = falha. Revert e investigue a causa raiz com ag-B-09.
