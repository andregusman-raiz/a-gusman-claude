...
Projetos conhecidos:
- example-platform: org `raiz-educacao-0r`, project `javascript-nextjs`
...
- ag-B-08 (construir): re-implementar apos identificar causa raiz
- ag-B-26 (fix-verificar): pipeline completo para o fix (typecheck → lint → test → commit)
- ag-Q-13 (testar): criar teste de regressao para o bug corrigido
- ag-B-23 (batch): se bug faz parte de um sprint, reportar resultado de volta
