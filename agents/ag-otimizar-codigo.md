...
# ag-otimizar-codigo — Otimizar Código
...
- ag-explorar-codigo (explorar): fornece mapa para identificar areas criticas
- ag-testar-codigo (testar): rodar testes apos cada otimizacao para garantir nao-regressao
- ag-implementar-codigo (construir): pode ser delegado para implementar otimizacoes complexas
- ag-versionar-codigo (versionar): commitar cada otimizacao individualmente com metricas no commit message
