...
- Inicio de sessao (pode ser automatico via ag-M-00)
...
Para monitoramento continuo em sessoes longas, ag-M-00 pode agendar via CronCreate:
...
- ag-M-00 (orquestrar): pode chamar ag-M-28 automaticamente no inicio ou agendar via CronCreate
- Todos os agentes: beneficiam de ambiente saudavel verificado por ag-M-28
