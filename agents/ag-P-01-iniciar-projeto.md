...
```
/ag-P-01 → Modo interativo (pergunta tipo, stack)
/ag-P-01 [stack] [nome] → Direto com defaults inteligentes
```
...
- ag-P-02 (setup-ambiente): chama ag-P-02 apos scaffolding para completar setup
- ag-P-03 (explorar): mapear codebase apos scaffold
