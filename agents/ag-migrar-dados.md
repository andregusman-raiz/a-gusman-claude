...
```
/ag-migrar-dados criar [tabela]       -> Migration de nova tabela
/ag-migrar-dados alterar [tabela]     -> Migration de alteracao
/ag-migrar-dados backfill [dados]     -> Migration de dados
/ag-migrar-dados validar              -> Valida migrations pendentes
```
