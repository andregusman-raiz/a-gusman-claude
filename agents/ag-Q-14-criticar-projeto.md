...
estilo. Diferente de auditoria (ag-Q-15) — review e dialogo sobre design,
...
```
/ag-Q-14 [branch ou PR]    -> Review completo
/ag-Q-14 diff [commit]     -> Review de commit especifico
/ag-Q-14 design [arquivo]  -> Foca em decisoes de design
```
