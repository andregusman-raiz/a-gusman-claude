...
- Due diligence concluida (ag-32) com recomendacao GO
...
2. Explorar codebase do rAIz (ag-03 subagent se necessario)
...
- ag-32 (due-diligence): fornece o relatorio base
- ag-03 (explorar): mapeia codebase quando necessario
- ag-34 (planejar-incorporacao): consome o mapa para criar roadmap
