...
```
/ag-D-17-migrar-dados criar [tabela]       -> Migration de nova tabela
/ag-D-17-migrar-dados alterar [tabela]     -> Migration de alteracao
/ag-D-17-migrar-dados backfill [dados]     -> Migration de dados
/ag-D-17-migrar-dados validar              -> Valida migrations pendentes
```
