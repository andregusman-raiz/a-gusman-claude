...
- Se 1 bug claro → usar ag-26 (fix-verificar)
- Se 1 bug obscuro → usar ag-09 (depurar) → ag-26 (fix-verificar)
- Se > 5 bugs independentes em modulos diferentes → usar ag-24 (bugfix-paralelo)
...
Limites: max 3 teammates para batch (ag-24 para 5+). Apos todos completarem: `TeamDelete`.
