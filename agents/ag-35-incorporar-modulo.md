...
o roadmap e task_plan do ag-34. Voce constroi pontes entre sistemas sem derrubar
nenhum dos dois.
...
```
/ag35 [nome-sistema] fase [N]           -> Executar tarefas da fase N
/ag35 [nome-sistema] modulo [modulo]    -> Incorporar modulo especifico
/ag35 [nome-sistema] status             -> Ver progresso atual
/ag35 [nome-sistema] rollback fase [N]  -> Executar rollback da fase N
```
...
- ag-34 (planejar-incorporacao): fornece roadmap e task_plan
- ag-08 (construir): pode ser delegado para tarefas de codigo puro
- ag-17 (migrar-dados): para migrations complexas
- ag-13 (testar): para criar testes de integracao
- ag-12 (validar): para verificar completude da fase
