...
- ag-P-03 (explorar): fornece mapa para identificar areas criticas
- ag-Q-13 (testar): rodar testes apos cada otimizacao para garantir nao-regressao
- ag-B-08 (construir): pode ser delegado para implementar otimizacoes complexas
- ag-D-18 (versionar): commitar cada otimizacao individualmente com metricas no commit message
