...
> Regra nascida do incidente 2026-04-07 no `data-engine-app`: 3 corrupções de branch state (rename, reset, force-push) e 23 stashes acumulados por múltiplas sessões Claude escrevendo no mesmo working tree sem isolamento.
...
6. **Plano de triagem:** seguir o modelo de `~/Claude/docs/diagnosticos/2026-04-07-data-engine-app-wip-triage.md` (Fases 1-5)

---

## Referências

- Plano original do incidente: `docs/diagnosticos/2026-04-07-data-engine-app-wip-triage.md`
