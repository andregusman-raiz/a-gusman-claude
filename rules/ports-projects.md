...
| **4200** | cockpit ao vivo (só-leitura) | `~/Claude/docs/ai-state/cockpit/` | launchd `com.raiz.cockpit-server` (python http.server, 127.0.0.1) — substitui o antigo raiz-agent-dashboard (dir inexistente) |
