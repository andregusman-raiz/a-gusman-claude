...
> **Nasce de:** incidente 2026-04-07 (3 corrupções de branch state + 23 stashes acumulados no `data-engine-app` por multiple sessions Claude).
...
```
✓ CORRETO: "Trabalhe no repo em ~/Claude/GitHub/example-platform/"
✗ ERRADO:  "no example-platform"
```
...
6. **Plano de triagem:** modelo em `~/Claude/docs/diagnosticos/2026-04-07-data-engine-app-wip-triage.md` (Fases 1-5)
