...
## Best implementation
- **Chat Panel**: `~/Claude/GitHub/example-automata/components/chat/chat-panel.tsx`
- **Messages**: `~/Claude/GitHub/example-automata/components/chat/chat-messages.tsx`
- **Input**: `~/Claude/GitHub/example-automata/components/chat/chat-input.tsx`
- **API Route**: `~/Claude/GitHub/example-automata/app/api/chat/route.ts`
