...
## Best implementation
- `~/Claude/GitHub/example-platform/src/components/rag/RagPanel.tsx` (orchestrator)
- `~/Claude/GitHub/example-platform/src/components/rag/DocumentList.tsx`
- `~/Claude/GitHub/example-platform/src/components/rag/DocumentUpload.tsx`
- `~/Claude/GitHub/example-platform/src/components/rag/FolderStats.tsx`
