...
source: payroll-app + auditoria-raiz
complexity: high
---
...
- **Table + Filters**: `~/Claude/GitHub/payroll-app/src/components/funcionarios/funcionarios-table.tsx` (221 lines)
- **Global Filters**: `~/Claude/GitHub/payroll-app/src/components/dashboard/global-filters.tsx` (220 lines)
- **Employee Filters**: `~/Claude/GitHub/payroll-app/src/components/funcionarios/employee-filters.tsx` (152 lines)
- **Export Button**: `~/Claude/GitHub/payroll-app/src/components/ui/export-button.tsx`
- **Multi-sheet Excel**: `~/Claude/GitHub/auditoria-raiz/src/app/api/export-excel/route.ts`
- **Multi-select dropdown**: `~/Claude/GitHub/fin-platform/src/components/dashboard/multi-select.tsx` (140 lines)
