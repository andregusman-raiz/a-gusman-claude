...
- `~/Claude/GitHub/example-platform/src/components/social-media/publishing/PostComposer.tsx`
- `~/Claude/GitHub/example-platform/src/components/social-media/publishing/ContentCalendar.tsx`
- `~/Claude/GitHub/example-platform/src/components/social-media/publishing/PlatformSelector.tsx`
