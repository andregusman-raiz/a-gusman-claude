...
- `~/Claude/GitHub/example-platform/src/components/contencioso/settings/`
- `~/Claude/GitHub/example-platform/src/app/(auth)/contencioso/casos/[caseRecordId]/estrategia/page.tsx`
- `~/Claude/GitHub/example-platform/src/app/(auth)/contencioso/provisoes/page.tsx`
- `~/Claude/GitHub/example-platform/src/app/(auth)/contencioso/copilot/page.tsx`
