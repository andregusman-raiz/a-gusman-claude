...
- `~/Claude/GitHub/example-platform/src/components/bi/GraphicWalkerExplorer.tsx`
- `~/Claude/GitHub/example-platform/src/components/bi/GraphicWalkerWrapper.tsx`
- `~/Claude/GitHub/example-platform/src/components/bi/BiChatPanel.tsx`
