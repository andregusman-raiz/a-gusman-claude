...
- `~/Claude/GitHub/example-platform/src/components/clm/ai/RiskAnalysisView.tsx`
- `~/Claude/GitHub/example-platform/src/components/clm/contracts/ContractNegotiationPanel.tsx`
- `~/Claude/GitHub/example-platform/src/components/clm/contracts/ContractVersionHistory.tsx`
- `~/Claude/GitHub/example-platform/src/components/clm/ai/ClauseSuggestions.tsx`
- `~/Claude/GitHub/example-platform/src/components/clm/contracts/ContractSignaturePanel.tsx`
