  ...
  return (
    ...
    >
      {videoSrc ? (
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(99,102,241,0.25),_transparent_60%),radial-gradient(ellipse_at_bottom,_rgba(16,185,129,0.2),_transparent_60%)]"
        />
      )}
