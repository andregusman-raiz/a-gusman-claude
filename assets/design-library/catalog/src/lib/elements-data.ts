...
export const elements: UIElement[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // NEW FROM ad-insights-hub, Salvaguarda-next, dre-raiz (2026-03-27)
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // Data Display — from dre-raiz
  { id: "hierarchical-drilldown-table", name: "Hierarchical Drill-Down Table", desc: "Tabela DRE/P&L com expand/collapse por nível hierárquico. Totais automáticos, highlight de variância.", category: "Data Display", subcategory: "Tables", lib: "TanStack Table + custom tree", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["dre", "drill-down", "hierarquia", "financeiro", "variância"], preview: "table-tree" },
  { id: "table-density-switcher", name: "Table Density Mode Switcher", desc: "Toggle compact/normal/expanded para tabelas de dados. Ajusta padding, font-size e row height.", category: "Data Display", subcategory: "Controls", lib: "shadcn/ui ToggleGroup", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["tabela", "densidade", "compact", "expanded", "toggle"], preview: "toggle" },
  { id: "multi-format-export-bar", name: "Multi-Format Export Bar", desc: "Barra fixa com export simultâneo XLSX + PDF + DOCX + PPTX. Loading individual por formato.", category: "Actions", subcategory: "Export", lib: "ExcelJS + PDFKit + docx + pptxgenjs", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["export", "xlsx", "pdf", "docx", "pptx", "multi-formato"], preview: "button-group" },
  ...
  // Dashboards — from dre-raiz
  { id: "financial-variance-chart", name: "Financial Variance Waterfall Chart", desc: "Waterfall chart mostrando variância orçado vs realizado com barras positivas/negativas.", category: "Dashboards", subcategory: "Charts", lib: "Recharts", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["waterfall", "variância", "orçamento", "realizado", "financeiro"], preview: "chart-bar" },
  { id: "pareto-chart", name: "Pareto Chart (80/20)", desc: "Dual Y-axis: barras (valores absolutos) + linha (% acumulado). Regra 80/20 com annotation.", category: "Dashboards", subcategory: "Charts", lib: "ECharts / Recharts", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["pareto", "80-20", "dual-axis", "acumulado", "análise"], preview: "chart-bar" },
  { id: "variance-heatmap", name: "Variance Heatmap Table", desc: "Tabela com células coloridas por score de variância (verde=favorável, vermelho=desfavorável). Semáforo automático.", category: "Data Display", subcategory: "Tables", lib: "ECharts / HTML Table", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["heatmap", "variância", "semáforo", "cores", "score"], preview: "table-rows" },
  { id: "calc-row-highlight", name: "Calc Row with Orange Highlight", desc: "Linha de totais/subtotais com background laranja, texto branco, font-black. Para MARGEM, EBITDA, etc.", category: "Data Display", subcategory: "Tables", lib: "Tailwind custom", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["total", "subtotal", "highlight", "margem", "ebitda", "calc"], preview: "table-rows" },
  { id: "invert-delta-indicator", name: "InvertDelta Variance Indicator", desc: "Badge de variância que inverte cores para custos (gastar menos = verde). Lógica: invertDelta flag por seção.", category: "Data Display", subcategory: "Indicators", lib: "Custom logic", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["delta", "variância", "custos", "receita", "inversão", "badge"], preview: "badge" },
  { id: "pptx-slide-preview", name: "PPTX Slide Preview Component", desc: "Preview ao vivo de slides PPTX no browser antes de gerar. Mostra layout 13.33×7.5 com header/footer bars.", category: "Media", subcategory: "Preview", lib: "React + pptxgenjs types", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["pptx", "preview", "slides", "apresentação", "browser"], preview: "docs" },
  { id: "ai-insights-box", name: "AI Insights Box (Dark Navy)", desc: "Box escuro (navy) com pill 'SÍNTESE IA' laranja + texto claro. Para contextualizar dados com análise AI.", category: "Feedback", subcategory: "AI", lib: "shadcn/ui + custom", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["ai", "insights", "síntese", "box", "navy", "análise"], preview: "alert" },
  { id: "kpi-card-with-strip", name: "KPI Card with Color Strip", desc: "Card branco com shadow + faixa de cor no topo (seção financeira). Valor grande + label pequeno.", category: "Data Display", subcategory: "KPI", lib: "pptxgenjs / React", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["kpi", "card", "faixa", "cor", "seção", "financeiro"], preview: "kpi" },
  { id: "brand-comparison-card", name: "Brand/Unit Comparison Card", desc: "Card com borda colorida esquerda indicando favorabilidade. Nome + Real + Δ% + seta ▲/▼.", category: "Data Display", subcategory: "Cards", lib: "Custom", repo: "Raiz-Educacao-SA/dre-raiz", tags: ["marca", "comparação", "card", "favorável", "desfavorável"], preview: "kpi" },
];
