...
export const elements: UIElement[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // NEW FROM ad-insights-hub, Salvaguarda-next, report-app (2026-03-27)
  // ═══════════════════════════════════════════════════════════════════════════

  // Data Display — from ad-insights-hub
  { id: "metric-card-benchmark", name: "Metric Card with Benchmark Band", desc: "KPI card com banda visual comparativa (acima/dentro/abaixo da meta). Cores automáticas por performance.", category: "Data Display", subcategory: "KPI", lib: "shadcn/ui Card + custom", repo: "Raiz-Educacao-SA/ad-insights-hub", tags: ["kpi", "benchmark", "meta", "banda", "performance", "ads"], preview: "kpi" },
  { id: "role-aware-dashboard", name: "Role-Aware Dashboard Split", desc: "Dashboard que exibe views diferentes por role (admin/viewer/analyst). Server-side role resolution.", category: "Dashboards", subcategory: "Layout", lib: "Next.js Server Components", repo: "Raiz-Educacao-SA/ad-insights-hub", tags: ["dashboard", "rbac", "role", "split", "server-components"], preview: "dashboard" },
  { id: "ad-campaign-grid", name: "Campaign Performance Grid", desc: "Grid de campanhas com ROAS, CPL, CTR badges coloridos por threshold. Drill-down para criativos.", category: "Data Display", subcategory: "Tables", lib: "TanStack Table + shadcn/ui", repo: "Raiz-Educacao-SA/ad-insights-hub", tags: ["campanhas", "roas", "cpl", "ctr", "ads", "grid"], preview: "table-rows" },
  { id: "balance-alert-banner", name: "Balance Alert Banner", desc: "Banner de alerta com threshold de saldo restante. Severidade auto-calculada (info/warning/critical).", category: "Feedback", subcategory: "Alerts", lib: "shadcn/ui Alert", repo: "Raiz-Educacao-SA/ad-insights-hub", tags: ["alerta", "saldo", "threshold", "severidade", "banner"], preview: "alert" },

  // Data Display — from report-app
  { id: "hierarchical-drilldown-table", name: "Hierarchical Drill-Down Table", desc: "Tabela DRE/P&L com expand/collapse por nível hierárquico. Totais automáticos, highlight de variância.", category: "Data Display", subcategory: "Tables", lib: "TanStack Table + custom tree", repo: "Raiz-Educacao-SA/report-app", tags: ["dre", "drill-down", "hierarquia", "financeiro", "variância"], preview: "table-tree" },
  { id: "table-density-switcher", name: "Table Density Mode Switcher", desc: "Toggle compact/normal/expanded para tabelas de dados. Ajusta padding, font-size e row height.", category: "Data Display", subcategory: "Controls", lib: "shadcn/ui ToggleGroup", repo: "Raiz-Educacao-SA/report-app", tags: ["tabela", "densidade", "compact", "expanded", "toggle"], preview: "toggle" },
  { id: "multi-format-export-bar", name: "Multi-Format Export Bar", desc: "Barra fixa com export simultâneo XLSX + PDF + DOCX + PPTX. Loading individual por formato.", category: "Actions", subcategory: "Export", lib: "ExcelJS + PDFKit + docx + pptxgenjs", repo: "Raiz-Educacao-SA/report-app", tags: ["export", "xlsx", "pdf", "docx", "pptx", "multi-formato"], preview: "button-group" },

  // Workflow — from Salvaguarda-next
  { id: "evidence-upload-ai", name: "Evidence Upload with AI Feedback", desc: "Upload de evidências com preview, análise AI inline (qualidade, completude), retry com guidance.", category: "Workflow", subcategory: "Upload", lib: "Vercel Blob + AI SDK", repo: "Raiz-Educacao-SA/Salvaguarda-next", tags: ["upload", "evidência", "ai", "análise", "feedback", "qualidade"], preview: "upload" },
  { id: "audit-approval-workflow", name: "Audit/Approval Workflow Panel", desc: "Timeline de aprovação com estados (pendente/aprovado/rejeitado/revisão), comentários por etapa, SLA badges.", category: "Workflow", subcategory: "Approval", lib: "shadcn/ui + custom state machine", repo: "Raiz-Educacao-SA/Salvaguarda-next", tags: ["auditoria", "aprovação", "timeline", "sla", "workflow", "evidência"], preview: "timeline" },
  { id: "async-job-polling", name: "Async Job Polling UI", desc: "Indicador de progresso para jobs assíncronos (PDF generation, AI analysis). Polling com exponential backoff.", category: "Feedback", subcategory: "Progress", lib: "React hooks + SWR", repo: "Raiz-Educacao-SA/Salvaguarda-next", tags: ["async", "polling", "progresso", "job", "backoff", "loading"], preview: "spinner" },
  { id: "compliance-checklist", name: "Compliance Checklist with Evidence", desc: "Checklist regulatória com anexo de evidência por item, status automático, score de conformidade.", category: "Workflow", subcategory: "Compliance", lib: "shadcn/ui Checkbox + custom", repo: "Raiz-Educacao-SA/Salvaguarda-next", tags: ["compliance", "checklist", "evidência", "regulatório", "score"], preview: "checklist" },

  // Dashboards — from report-app
  { id: "financial-variance-chart", name: "Financial Variance Waterfall Chart", desc: "Waterfall chart mostrando variância orçado vs realizado com barras positivas/negativas.", category: "Dashboards", subcategory: "Charts", lib: "Recharts", repo: "Raiz-Educacao-SA/report-app", tags: ["waterfall", "variância", "orçamento", "realizado", "financeiro"], preview: "chart-bar" },
  { id: "pareto-chart", name: "Pareto Chart (80/20)", desc: "Dual Y-axis: barras (valores absolutos) + linha (% acumulado). Regra 80/20 com annotation.", category: "Dashboards", subcategory: "Charts", lib: "ECharts / Recharts", repo: "Raiz-Educacao-SA/report-app", tags: ["pareto", "80-20", "dual-axis", "acumulado", "análise"], preview: "chart-bar" },
  { id: "variance-heatmap", name: "Variance Heatmap Table", desc: "Tabela com células coloridas por score de variância (verde=favorável, vermelho=desfavorável). Semáforo automático.", category: "Data Display", subcategory: "Tables", lib: "ECharts / HTML Table", repo: "Raiz-Educacao-SA/report-app", tags: ["heatmap", "variância", "semáforo", "cores", "score"], preview: "table-rows" },
  { id: "calc-row-highlight", name: "Calc Row with Orange Highlight", desc: "Linha de totais/subtotais com background laranja, texto branco, font-black. Para MARGEM, EBITDA, etc.", category: "Data Display", subcategory: "Tables", lib: "Tailwind custom", repo: "Raiz-Educacao-SA/report-app", tags: ["total", "subtotal", "highlight", "margem", "ebitda", "calc"], preview: "table-rows" },
  { id: "invert-delta-indicator", name: "InvertDelta Variance Indicator", desc: "Badge de variância que inverte cores para custos (gastar menos = verde). Lógica: invertDelta flag por seção.", category: "Data Display", subcategory: "Indicators", lib: "Custom logic", repo: "Raiz-Educacao-SA/report-app", tags: ["delta", "variância", "custos", "receita", "inversão", "badge"], preview: "badge" },
  { id: "pptx-slide-preview", name: "PPTX Slide Preview Component", desc: "Preview ao vivo de slides PPTX no browser antes de gerar. Mostra layout 13.33×7.5 com header/footer bars.", category: "Media", subcategory: "Preview", lib: "React + pptxgenjs types", repo: "Raiz-Educacao-SA/report-app", tags: ["pptx", "preview", "slides", "apresentação", "browser"], preview: "docs" },
  { id: "ai-insights-box", name: "AI Insights Box (Dark Navy)", desc: "Box escuro (navy) com pill 'SÍNTESE IA' laranja + texto claro. Para contextualizar dados com análise AI.", category: "Feedback", subcategory: "AI", lib: "shadcn/ui + custom", repo: "Raiz-Educacao-SA/report-app", tags: ["ai", "insights", "síntese", "box", "navy", "análise"], preview: "alert" },
  { id: "kpi-card-with-strip", name: "KPI Card with Color Strip", desc: "Card branco com shadow + faixa de cor no topo (seção financeira). Valor grande + label pequeno.", category: "Data Display", subcategory: "KPI", lib: "pptxgenjs / React", repo: "Raiz-Educacao-SA/report-app", tags: ["kpi", "card", "faixa", "cor", "seção", "financeiro"], preview: "kpi" },
  { id: "brand-comparison-card", name: "Brand/Unit Comparison Card", desc: "Card com borda colorida esquerda indicando favorabilidade. Nome + Real + Δ% + seta ▲/▼.", category: "Data Display", subcategory: "Cards", lib: "Custom", repo: "Raiz-Educacao-SA/report-app", tags: ["marca", "comparação", "card", "favorável", "desfavorável"], preview: "kpi" },
];
