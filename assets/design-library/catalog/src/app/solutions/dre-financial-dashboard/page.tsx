...
// These are directly extracted from report-app and can be reused in any project.
...
export default function DreFinancialDashboardPage() {
  ...
  return (
    <SolutionLayout id="dre-financial-dashboard" title="Financial Drill-Down + Variance" source="report-app" category="Finance">
