...
## Best implementation
- **App Shell**: `~/Claude/projetos/edu-portal/src/components/layout/app-shell.tsx` (310 lines)
- **Sidebar**: `~/Claude/projetos/edu-portal/src/components/layout/sidebar.tsx` (213 lines)
- **Topbar**: `~/Claude/projetos/edu-portal/src/components/layout/topbar.tsx` (207 lines)
