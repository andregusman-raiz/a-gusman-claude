...
tags: [sample-saas, wizard, ai-build, pipeline, preview, deploy]
---
...
- `~/Claude/GitHub/example-platform/src/components/sample-saas/VibeCodingExecutionView.tsx`
- `~/Claude/GitHub/example-platform/src/components/sample-saas/VibeCodingWizard.tsx`
- `~/Claude/GitHub/example-platform/src/components/sample-saas/EmbeddedApp.tsx`
- `~/Claude/GitHub/example-platform/src/components/sample-saas/VibeCodingProgress.tsx`
- `~/Claude/GitHub/example-platform/src/components/sample-saas/VibeCodingDecisionCard.tsx`
