...
- `~/Claude/GitHub/example-platform/src/components/totvs-sql/api-factory/ApiFactoryDashboard.tsx`
- `~/Claude/GitHub/example-platform/src/components/totvs-sql/api-factory/CodeSnippetGenerator.tsx`
- `~/Claude/GitHub/example-platform/src/components/totvs-sql/documentation/DocumentationViewer.tsx`
- `~/Claude/GitHub/example-platform/src/components/data-explorer/DataExplorer.tsx`
