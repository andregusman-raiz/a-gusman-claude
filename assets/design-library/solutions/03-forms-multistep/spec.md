...
## Best implementation
- **DynamicForm**: `~/Claude/GitHub/ticket-app/src/components/bpms/forms/dynamic-form.tsx`
- **Form Engine**: `~/Claude/GitHub/ticket-app/src/lib/bpms/forms/form-engine.ts`
- **Process Start**: `~/Claude/GitHub/ticket-app/src/components/bpms/start/process-start-form.tsx`
