...
- `~/Claude/GitHub/example-platform/src/components/content-studio/TiptapEditor.tsx`
- `~/Claude/GitHub/example-platform/src/components/content-studio/ImageEditCanvas.tsx`
- `~/Claude/GitHub/example-platform/src/components/content-studio/InfographicCreator.tsx`
- `~/Claude/GitHub/example-platform/src/components/content-studio/presentation/editor/SlideCanvas.tsx`
- `~/Claude/GitHub/example-platform/src/components/content-studio/presentation/editor/SlideNavigator.tsx`
