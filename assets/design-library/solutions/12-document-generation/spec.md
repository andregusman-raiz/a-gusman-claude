...
## Best implementation
- **PDF**: `~/Claude/projetos/docs-app/src/lib/export/export-pdf.ts`
- **Word**: `~/Claude/projetos/docs-app/src/lib/export/export-docx.ts`
- **Excel**: `~/Claude/projetos/docs-app/src/lib/export/export-xlsx.ts`
- **Common**: `~/Claude/projetos/docs-app/src/lib/export/common.ts`
- **UI**: `~/Claude/projetos/docs-app/src/components/consulta/export-buttons.tsx`
