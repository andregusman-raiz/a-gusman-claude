...
- **Kanban**: `~/Claude/projetos/agent-dashboard/src/components/kanban/KanbanBoard.tsx`
- **Column**: `~/Claude/projetos/agent-dashboard/src/components/kanban/KanbanColumn.tsx`
- **Card**: `~/Claude/projetos/agent-dashboard/src/components/kanban/KanbanCard.tsx`
- **Timeline**: `~/Claude/projetos/agent-dashboard/src/components/agents/AgentTimeline.tsx`
